...
class _RockPaperScissorsGameState extends State<RockPaperScissorsGame> {
  ...
  void _playGame(String userChoice) {
    setState(() {
      ...
      if (_totalPlays % 5 == 0) {
        _computerChoice = _getLosingChoice(userChoice);
        _userWins++;
      } else {
  ...
  String _getLosingChoice(String userChoice) {
    if (userChoice == 'Pedra') return 'Tesoura';
    if (userChoice == 'Papel') return 'Pedra';
    return 'Papel'; // userChoice == 'Tesoura'
  }
